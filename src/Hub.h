...
public:
    ...
    Group<isServer> *createGroup(int extensionOptions = 0) {
        return new Group<isServer>(extensionOptions, this);
    }
    ...
    Hub(int extensionOptions = 0, bool useDefaultLoop = false) : uS::Loop(useDefaultLoop), Group<SERVER>(extensionOptions, this), Group<CLIENT>(0, this) {
